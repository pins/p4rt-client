...
var routerIntTableId = flag.Uint("routerTable", 0, "id for ingress.routing.router_interface_table from p4info.txt")
...
var setMacPort = flag.Uint("setPortMac", 0, "action id associated with action ingress.routing.set_port_and_src_mac ")
...
var neighborTable = flag.Uint("neighborTable", 0, "id associated with ingress.routing.neighbor_table from p4info.txt")
var setDestMac = flag.Uint("setDestMacAction", 0, "id associated with ingress.routing.set_dst_mac from p4info.txt")
...
var nextHopTable = flag.Uint("nextHopTable", 0, "table id associated with ingress.routing.nexthop_table from p4info.txt")
var nextHopId = flag.String("nextHopId", "", "name to associate with next hop entry")
var nextHopAction = flag.Uint("setNextHopAction", 0, "action id associated with ingress.routing.set_nexthop_id from p4info.txt")
...
var ipv4Table = flag.Uint("ipv4table", 0, "id associated with ingress.routing.ipv4_table from p4info.txt")
var setNextHopId = flag.Uint("setNextHop", 0, "id associated with action ingress.routing.set_nexthop_id from p4info.txt")
...
var actionProfileId = flag.Uint("aProfileId", 0, "table id associated with ingress.routing.wcmp_group_table from p4info.txt")
...
var setWcmpId = flag.Uint("setWcmpId", 0, "id associated with ingress.routing.set_wcmp_group_id")
