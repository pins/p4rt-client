...
import (
   ...
   "github.com/pins/p4rt-client/v3/internal/tables"
   "log"
   "strconv"
   "strings"
)
...
*/
func DeleteRouterIntEntry(serverAddressPort *string, routerInterfaceId *string, routerIntTableId *uint) {
   if *serverAddressPort=="" || *routerInterfaceId == "" {
      DelRouterIntUsage()
...
*/
func DelNeighborEntry(serverAddressPort *string,routerInterfaceId *string, neighborName *string, neighborTable *uint) {
...
*/
func DelNextHopEntry(serverAddressPort *string, nextHopId *string, nextHopTable *uint) {
...
func AddVRF(serverAddressPort *string, vrfId *string, vrfTable *uint, addVrf *uint){
  if becomeMaster(getP4Client(serverAddressPort)) {
     ...
     updates := tables.VrfTableInsert( vrfConfig)
     p4client.writeRequest(updates)
  }
...
*/
func DelIpV4TableEntry(serverAddressPort *string, vrfId *string, destNetwork *string, ipv4Table *uint) {
...
*/
func DeleteActionProfileEntry(serverAddressPort *string, groupId *string, actionProfileAction *uint) {
